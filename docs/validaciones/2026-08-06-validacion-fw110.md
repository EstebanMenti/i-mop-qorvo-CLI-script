...
> **Placa:** COM26+COM28 · **Fecha:** 2026-08-06 12:35:24
...
| A7 LISTCAL | PASS | 0.2 s | 259 claves; ant0.ch9.ant_delay=0x3FF7 |
| A8 CALKEY (lectura) | PASS | 0.3 s | ant0.ch9.ant_delay=0x3FF7 (16375), len 4 |
...
| C4 Sesión TWR (2 placas) | PASS | 11.6 s | 50/50 mediciones SUCCESS; ejemplo: 16 cm |
