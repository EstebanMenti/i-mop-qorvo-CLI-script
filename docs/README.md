...
| [gui-calibracion-ble.md](gui-calibracion-ble.md) | **Guía de uso de las pestañas "Calibración BLE" y "Medir"** de `dwm-gui` (únicas dos pestañas en esta rama): calibración de antenna delay y medición continua sin calibrar, con **ambos nodos por Bluetooth** (escaneo BLE con filtro, selección de INITIATOR/RESPONDER, estado y distancia en vivo con desvío) | Usuarios |
