...
| [gui-calibracion-ble.md](gui-calibracion-ble.md) | **Guía de uso de la pestaña "Calibración BLE"** de `dwm-gui`: calibración de antenna delay con **ambos nodos por Bluetooth** (escaneo BLE con filtro, selección de INITIATOR/RESPONDER, distancia real, estado y distancia en vivo) | Usuarios |
